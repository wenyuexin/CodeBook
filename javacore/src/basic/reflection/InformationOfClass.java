...
public class InformationOfClass {
	public static void main(String[] args) {
		...
		//Returns the name of the entity (class, interface, basic.array class,primitive type, or void)
		...
		//Returns a basic.string describing this Class,
		...
		//getTypeName: Return an informative basic.string for the name of this type
	    ...
	    //it is a local or anonymous class or an basic.array whose component
